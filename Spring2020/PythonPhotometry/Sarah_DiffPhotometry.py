...
def diffPhot_IndividualStars(datadir, memberlist, ra_all, dec_all, xpos, ypos, dPhotometry, edPhotometry, tePhotometry, times, target, fitsimage, most_accurate,verbose=1):
    '''
